...
type TabKey = 'overview' | 'guests' | 'campaigns' | 'objectives' | 'scoring' | 'seating' | 'checkin' | 'briefings' | 'broadcast' | 'follow-up' | 'rsvp-page' | 'analytics' | 'activity-log'
...
export function EventTabNavigation({ eventId }: EventTabNavigationProps) {
  ...
  const tabs: { key: TabKey; label: string; href: string }[] = [
    ...
    { key: 'analytics', label: 'Analytics', href: `/dashboard/${eventId}/analytics` },
    { key: 'activity-log', label: 'Activity Log', href: `/dashboard/${eventId}/activity-log` },
  ]
