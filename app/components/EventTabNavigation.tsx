...
export function EventTabNavigation({ eventId }: EventTabNavigationProps) {
  ...
  const tabs: TabDef[] = [
    ...
    { key: 'activity-log', label: 'Activity Log', href: `/dashboard/${eventId}/activity-log`, phase: 'POST-EVENT' },
  ]
  ...
  return (
    <nav className="-mb-px">
      <div className="flex items-center gap-1 overflow-x-auto scrollbar-hide pr-8">
        {tabs.map((tab, idx) => {
