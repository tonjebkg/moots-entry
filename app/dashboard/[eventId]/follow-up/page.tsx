  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold font-display text-brand-charcoal tracking-tight">Follow-Up</h2>
        ...
        {followUps.length > 0 && (
          <a
            ...
            className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-ui-secondary border border-ui-border rounded-lg hover:bg-brand-cream transition-colors"
          >
      ...
      {followUps.length > 0 && (
        <div className="grid grid-cols-6 gap-3">
          {[
            { label: 'Total', value: stats.total || 0, color: 'bg-gray-50 text-brand-charcoal' },
            ...
            <div key={s.label} className={`rounded-lg p-3 border border-ui-border ${s.color}`}>
